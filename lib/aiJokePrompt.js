...
const TOPICS = [
  'a plumber', 'a librarian', 'a baker', 'a dentist', 'a gardener',
  'a photographer', 'a mailman', 'a lifeguard', 'a chemist', 'a pilot',
  'a carpenter', 'a fisherman', 'a tailor', 'a weatherman', 'a zookeeper',
  'an electrician', 'a geologist', 'a chef', 'a mechanic', 'a teacher',
  'a painter', 'a sailor', 'a farmer', 'a mathematician', 'a musician',
];
...
1. Start with this randomly assigned subject: **${topic}**. Build your joke around their work, tools, or a situation they'd encounter.
