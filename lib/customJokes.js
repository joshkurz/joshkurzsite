...
async function ensureInitialized() {
  ...
  // Reset on failure so a transient DynamoDB error doesn't permanently wedge
  // this in a rejected state for the lifetime of the process — the next call
  // gets a fresh retry instead of the same cached rejection forever.
  const promise = refreshAcceptedJokes().catch((error) => {
