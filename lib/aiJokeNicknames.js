...
// Turns a raw stored `author` string (plus optional live-generation metadata)
// into a display-friendly name — an AI nickname for AI-generated jokes, or
// the author as-is otherwise.
export function resolveDisplayAuthor(author, metadata) {
