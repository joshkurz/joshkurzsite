...
export async function buildInspirationBlock() {
  try {
    ...
    return [
      ...
      'Use that internal summary to craft a fresh joke that feels like it belongs in this winning set while remaining completely original. IMPORTANT: Do not reproduce, paraphrase, or closely echo any of the jokes listed above — they are examples of style only, not content to reuse.'
    ].join('\n');
  } catch (error) {
